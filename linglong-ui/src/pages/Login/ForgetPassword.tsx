...
import { forgotPassword, sendSmsCode } from '../../services/api'
import './index.css'
...
const ForgotPassword = () => {
  ...
  const handleSendCode = async () => {
    ...
    try {
      ...
      const code = res?.data
      if (code) {
        form.setFieldsValue({ verifyCode: code })
    ...
    <div className="login-container-split">
      ...
      <div className="login-left">
        <div className="brand-content">
          ...
          <div className="features-list">
            ...
            <div className="feature-item">
              <div className="feature-icon feature-icon--stack">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#79a3e2" strokeWidth="2">
      ...
      <div className="login-right">
        <div className="login-form-container">
          ...
          <Form form={form} onFinish={onFinish} className="login-form" size="large">
            <Form.Item
              name="mobile"
              rules={[
          ...
          <div className="register-link">
            记起密码了？<a onClick={() => navigate('/login')}>返回登录</a>
          </div>
        </div>
      </div>
    </div>
